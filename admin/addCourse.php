    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <form action="addedCourse.php" method="POST">
			  <div class="form-row">
			 ...
			 <div class="form-row">
			    <div class="form-group col-md-6">
			      ...
			      <input type="text" class="form-control" id="fieldOfStudy" name="fieldOfStudy" placeholder="Field Of Study" required>
			    </div>
			    <div class="form-group col-md-6">
			 ...
			 <div class="form-row">
			    <div class="form-group col-md-6">
			      ...
			      <input type="text" class="form-control" id="ielts" name="ielts" placeholder="Required IELTS" required>
			    </div>
			    <div class="form-group col-md-6">
			      <label for="cgpa">Required CGPA</label>
			       <input type="text" class="form-control" id="cgpa" name="cgpa" placeholder="Required CGPA" required>
			    </div>
			  </div>
			  <div class="form-row">
			    <div class="form-group col-md-6">
			      <label for="gre">Required GRE</label>
			      <input type="text" class="form-control" id="gre" name="gre" placeholder="Required GRE">
			    </div>
			    <div class="form-group col-md-6">
			      <label for="toefl">Required TOEFL</label>
			       <input type="text" class="form-control" id="toefl" name="toefl" placeholder="Required TOEFL">
			    </div>
			  </div>
			  <div class="form-row">
			    <div class="form-group col-md-6">
			    ...
			    <div class="form-group col-md-6">
			      <label for="courseFees">Course Fees</label>
			       <input type="text" class="form-control" id="courseFees" name="courseFees" placeholder="Course Fees" required>
			    </div>
			  </div>
			  ...
			  <center><button type="submit" class="btn btn-primary">Add Course</button></center>
			</form>
        <!-- Sticky Footer -->
